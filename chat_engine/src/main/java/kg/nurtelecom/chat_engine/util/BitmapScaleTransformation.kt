package kg.nurtelecom.chat_engine.util
...
class BitmapScaleTransformation : BitmapTransformation() {
    ...
    override fun equals(other: Any?): Boolean {
        return other is BitmapScaleTransformation
    }
    ...
    companion object {
        ...
        private const val ID = "kg.nurtelecom.chat_engine.util.BitmapScaleTransformation"
